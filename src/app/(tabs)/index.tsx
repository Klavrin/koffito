...
import { BottomSheet, Button, Card, Header, IconButton, Text, useToast } from "@/components/ui";
  ...
  return (
    <Screen
      ...
      <Section title="People you know" description="Friends you've shared a coffee with">
        <PeopleRow people={users} onSelect={setSelectedPerson} onDiscoverMore={() => router.push("/find-coffee-talk")} />
      </Section>
            ...
            <UserCard
              ...
              primaryAction={{
                ...
                onPress: () => {
                  ...
                  toast.show({ title: "Invite sent!", message: `${selectedPerson.name.split(" ")[0]} will hear from you soon.`, variant: "success" });
                },
              }}
            />
          </View>
